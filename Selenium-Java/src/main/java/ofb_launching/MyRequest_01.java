...
public class MyRequest_01
{
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		System.out.println(dropdown.getFirstSelectedOption().getText());
		  ...
		  System.out.println(driver.findElement(By.xpath("//span[text()='Select an option']")).getText());
		  driver.findElement(By.xpath("//span[text()='Select an option']")).click();
		  //driver.findElement(By.id("select2-_com_adjecti_pis_liferay_PISMVCPortlet_INSTANCE_p5BPx7EBhJaa_MyRequestForm_123456serviceRequestTypeId-result-1fu9-2")).click();
		  System.out.println(driver.findElement(By.xpath("//span/ul/li[2]")).getText());
		  driver.findElement(By.xpath("//span/ul/li[2]")).click();
		  driver.findElement(By.xpath("//div/textarea")).sendKeys("ABC");
		  driver.findElement(By.className("lfr-btn-label")).click();
